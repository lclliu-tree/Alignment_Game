...
network_data.to_csv(file_name_network, sep=',', encoding='utf-8', index=False, header=True)
print("Network simulation finished; this had two cliques, and one connection to file: final-1-lowconnectednetwork_cliques_2.csv" )