...
for cliques in cliques_count_list:
    ...
    while network_int < max_network_iteration:
        ...
        cliques_list.append([0,6])
        cliques_list.append([1,12])
        cliques_list.append([2,18])
        cliques_list.append([7,13])
        cliques_list.append([8,19])
        cliques_list.append([14,20])
        ...
        if network_int % 100 and network_int > 50:
            file_name_network = "1-simplenetwork_5prototypes_cliques_"+str(cliques)+".csv"
...
file_name_network = "0-simplenetwork_5prototypes_cliques_"+str(cliques)+".csv"
network_data.to_csv(file_name_network, sep=',', encoding='utf-8', index=False, header=True)
